...
export default function AdminUsers() {
  ...
  return (
    <main className="flex justify-center items-start h-full">
      <section className="w-full max-w-6xl px-4 py-6 space-y-10">
        <div>
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-5">
            <div>
              ...
              <p className="text-sm text-gray-400">
                Total: {stats.total} , Active: {stats.active} , Inactive:{" "}
                {stats.inactive}
              </p>
            </div>
                  ...
                  filtered.map((p) => (
                    <tr key={p.id} className="border-t border-white/10">
                      ...
                      <td className="p-3">
                        <span
                          className={
                            p.is_active ? "text-green-300" : "text-gray-400"
                          }
                        >
                          {p.is_active ? "Yes" : "No"}
                        </span>
        ...
        <div>
          ...
          <p className="text-sm text-gray-400 mb-4">
            Visual summary of user registrations and activity.
          </p>
          <AdminUsersMetrics />
        </div>
      </section>
